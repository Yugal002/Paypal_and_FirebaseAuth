...
import 'package:paypal_task/services/paypal_services.dart';
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    String userFirstName = 'Yugal';
    String userLastName = 'Jain';
    String addressCity = 'Raipur';
    String addressStreet = 'Mathura Road';
    String addressZipCode = '492001';
    String addressCountry = 'India';
    String addressState = 'Chhattisgarh';
